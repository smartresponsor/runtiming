...
and export them in Prometheus textfile format. See tools/runtime/collect-runtime-worker-metric.sh.
...
4. CI perf gate
tools/runtime/ci-perf-gate.sh compares p95 vs baseline and fails if regression is detected.
