...
verify_list=(
  "tools/runtime/verify-roadrunner-adapter.php"
  "tools/runtime/verify-bench-soak.php"
  "tools/runtime/verify-frankenphp-adapter.php"
  "tools/runtime/verify-swoole-adapter.php"
  "tools/runtime/verify-prod-runbook-pack.php"
)
